...
// LKPayment
#define COCOAPODS_POD_AVAILABLE_LKPayment
#define COCOAPODS_VERSION_MAJOR_LKPayment 0
#define COCOAPODS_VERSION_MINOR_LKPayment 1
#define COCOAPODS_VERSION_PATCH_LKPayment 0
